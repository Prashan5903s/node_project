...
exports.postQuizOptionAPI = async (req, res, next) => {
    try {
        ...
        const finalData = data.map(item => ({
            ...
            option1: item?.['Option 1'] || null,
            option2: item?.['Option 2'] || null,
            option3: item?.['Option 3'] || null,
            option4: item?.['Option 4'] || null,
            option5: item?.['Option 5'] || null,
            option6: item?.['Option 6'] || null,
